...
//                    byte[] bytes=Base64.decode(isSuccess,Base64.DEFAULT);
...
//                try {
//                    Looper.prepare();
//                    String path = "http://202.203.16.38:8080/HelloWeb/select" + "?name=" + "s";
//                     url = new URL(path);
//                    URLConnection urlConnection = url.openConnection();
//                    InputStream in = urlConnection.getInputStream();
//                    info = printInputStream(in);   //输出到控制台 并得到后台返回的信息 change by cxy
//                    isSuccess = String.valueOf(info);
//                    String getresult[]=isSuccess.split(" ");
//                    for(int i=0;i<getresult.length;i++){
//                        System.out.println(getresult[i]);
//                    }
////                    for(int i=0;i<isSuccess.length();i++){
////                        System.out.println(isSuccess[i]);
////                    }
//                    Looper.loop();
//
//                } catch (MalformedURLException e) {
...
//                try {
//                    Looper.prepare();
//                    String path = "http://202.203.16.38:8080/HelloWeb/updateprofilepicture" + "?cname=" + name+ "&image=" +pro_image ;
//                    URL url = new URL(path);
//                    URLConnection urlConnection = url.openConnection();
//                    InputStream in = urlConnection.getInputStream();
//                    printInputStream(in);
